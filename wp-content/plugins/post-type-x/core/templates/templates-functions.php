...
function ic_home_listing_query_args() {
	...
	$args = apply_filters( 'home_product_listing_query', array( 'post_status' => 'publish', 'post_type' => 'al_product', 'posts_per_page' => $multiple_settings[ 'archive_products_limit' ], 'paged' => $paged ) );
	return $args;
}
