...
if ( !class_exists( 'eCommerce_Product_Catalog' ) ) {
	...
	final class eCommerce_Product_Catalog {
		...
		public function implecode_enqueue_styles() {
			...
			wp_localize_script( 'al_product_scripts', 'product_object', apply_filters( 'ic_catalog_product_object_js', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ), 'post_id' => get_the_ID(), 'lightbox_settings' => $colorbox_set, 'filter_button_label' => __( 'Filter', 'post-type-x' ), 'design_schemes' => design_schemes( 'box', 0 ) ) ) );
