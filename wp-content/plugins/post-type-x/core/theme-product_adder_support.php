...
//$links[] = '<a href="https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-settings-link&key=support-link" target="_blank">Premium Support</a>';
	...
	function review_notice() {
		...
		<div class="notice notice-warning implecode-review is-dismissible">
			...
			<p><a target="_blank" href="https://wordpress.org/support/view/plugin-reviews/ecommerce-product-catalog#new-post" class="button-primary"><?php _e( 'Rate Now & Hide Forever', 'post-type-x' ); ?></a>
				<?php /* <a href="" class="button"><?php _e( 'Hide Forever', 'post-type-x' ); ?></a> */ ?>
		</div>
		<div class="update-nag implecode-review-thanks" style="display: none"><?php echo sprintf( __( 'Thank you for <a target="_blank" href="%s">your rating</a>! We appreciate your time and input.', 'post-type-x' ), 'https://wordpress.org/support/view/plugin-reviews/ecommerce-product-catalog#new-post' ) ?> <span class="dashicons dashicons-yes"></span></div><?php
	}
